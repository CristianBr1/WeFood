  ...
  const outlinedSx = {
    "& .MuiOutlinedInput-root": {
      ...
      "&.Mui-focused fieldset": {
        ...
        boxShadow: darkMode ? "0 0 0 3px rgba(74,222,128,0.08)" : "0 0 0 3px rgba(34,197,94,0.08)",
      },
    },
    "& .MuiInputLabel-root": {
      color: darkMode ? "#fff" : "#000",
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ width: "100%", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 14 }}>
            <Link to="/forgot-password" style={{ color: "#16a34a", textDecoration: "none", fontWeight: 500 }}>
              Esqueceu a senha?
            </Link>
          </div>
        ...
        <div style={{ marginTop: 14 }}>
          <div style={{ textAlign: "center", marginBottom: 8, color: darkMode ? "#9ca3af" : "#6b7280" }}>OU</div>
          <Button
            variant="outlined"
            fullWidth
            startIcon={<FcGoogle />}
